      ...
      <aside className="sidebar fixed lg:static w-[240px] bg-indigo-50 h-[calc(100vh-4rem)] lg:h-auto transform -translate-x-full lg:translate-x-0 transition-transform duration-300 z-110 overflow-y-auto p-4 scrollbar-thin scrollbar-thumb-indigo-100 scrollbar-track-transparent">
        ...
        <div className="bg-white rounded-xl shadow-lg mb-6 p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
          ...
          <NavLink
            to="/admin/blog"
            className={({ isActive }) =>
              `flex items-center cursor-pointer py-3 transition-all duration-300 hover:translate-x-1 ${isActive ? "text-indigo-800 font-bold text-[15px]" : "text-gray-600"
              }`
            }
          >
        ...
        <div className="bg-white rounded-xl shadow-lg mb-6 p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
          ...
          <NavLink
            to="/personCategory"
            className={({ isActive }) =>
              `flex items-center cursor-pointer py-3 transition-all text-[15px] duration-300 hover:translate-x-1 ${isActive ? "text-indigo-800 font-bold text-[15px]" : "text-gray-600"
              }`
            }
          >
        ...
        {/* <div className="bg-white rounded-xl shadow-lg mb-6 p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
          <NavLink
            to="/certificateType"
            className={({ isActive }) =>
              `flex items-center cursor-pointer py-2 transition-all duration-300 hover:translate-x-1 ${isActive ? "text-indigo-800 font-bold" : "text-gray-600"
              }`
            }
          >
